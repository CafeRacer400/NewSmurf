...
var AutoBuildTemplate = {
	...
	2:	{
			...
			StatPoints: [1,1,1,1,1],									// Energy 40
			Update: function () {
	...
	3:	{
			...
			StatPoints: [1,1,1,1,1],									// Energy 45
			Update: function () {
	...
	7:	{
			SkillPoints: [45, 39],										// Ice Blast + 1, Ice Bolt + 1 (level 3) (Normal Den of Evil Used)
	...
	10:	{
			SkillPoints: [39],											// ce Bolt + 1 (level 6)
	...
	12:	{
			...
			Update: function () {
				...
				Config.LifeChicken = 38; // Exit game if life is less or equal to designated percent.
				Config.TownHP = 61; // Go to town if life is under designated percent.
			}
		},
	...
	30:	{
			...
			StatPoints: [3, 3, 3, 3, 3, 3, 3, 3, 3, 3],					// Vitality + 10 (Norm Lam Esen's Tome) (115)
			Update: function () {
