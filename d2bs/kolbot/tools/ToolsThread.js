	...
	this.gameEvent = function (mode, param1, param2, name1, name2) {
		...
		case 0x03: // "%Name1(%Name2) left our world. Diablo's minions weaken."
			if ((typeof Config.QuitList === "string" && Config.QuitList.toLowerCase() === "any") ||
				...
				//added QuitList delays for profiles
				if (me.profile == "A1") { delay(rand(1000, 2000));}
				if (me.profile == "A2") { delay(rand(2500, 3500));} 
				if (me.profile == "A3") { delay(rand(4000, 5000));}
				if (me.profile == "A4") { delay(rand(4500, 5500));}
				if (me.profile == "A5") { delay(rand(4500, 5500));}
				if (me.profile == "A6") { delay(rand(4500, 5500));}
				quitFlag = true;
			}
